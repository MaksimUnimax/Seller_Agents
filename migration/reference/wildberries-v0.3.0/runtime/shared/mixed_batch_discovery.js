(() => {
  ...
  function discover(text, options = {}) {
    ...
    const commandPrefix = String(options.commandPrefix || "WB_API_V1");
    const helpPrefixV1 = String(options.helpPrefixV1 || "WB_HELP_V1");
    const helpPrefixV2 = String(options.helpPrefixV2 || "WB_HELP_V2");
    ...
    const markers = Object.freeze([
      ...
      ...(Array.isArray(options.additionalCommandPrefixes)?options.additionalCommandPrefixes:[]).map(prefix=>Object.freeze({kind:"api",prefix:String(prefix),version:null})),
        ...
        if (!discovery) {
          discovered.push(Object.freeze({
            ...
            discovery: Object.freeze({
              ...
              message: "WB_API_V1 marker could not be converted into a command discovery record."
            })
          }));
        } else {
          discovered.push(Object.freeze({
  ...
  globalThis.WBMixedBatchDiscovery = Object.freeze({ discover });
})();
