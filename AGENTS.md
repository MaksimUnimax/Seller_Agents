...
Только каркас, документация и её проверки. Не переносить production-код, не выполнять Ozon/WB запросы, не менять исходные ветки, не развёртывать сервис, не публиковать расширения и не создавать расписания мониторинга на этом этапе.
