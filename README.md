...
**Состояние: сервер перенесён в candidate из замороженного P8.4 Foundation; проверки переноса выполняются. Расширения ещё не перенесены, production не развёрнут.**
...
D0 завершён. Текущее поручение — D1.S1, перенос сервера и его проверка. После переноса сервер развивается параллельно отдельным Codex; основной архитектор ведёт перенос и объединение расширений.
