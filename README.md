...
**Сервер перенесён из замороженного P8.4 Foundation и прошёл полный CI в Seller_Agents. Расширения ещё не перенесены, production не развёрнут.**
...
D0 и D1.S1 (перенос сервера) завершены. Следующие отдельные работы: серверный Codex и перенос расширений. После переноса сервер развивается параллельно отдельным Codex; основной архитектор ведёт перенос и объединение расширений.
