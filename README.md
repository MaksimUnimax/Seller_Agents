...
**Сервер перенесён и проверен. Карта переноса Ozon 0.1.22/WB 0.3.0 готова; код расширений ещё не перенесён. Production не развёрнут.**
...
D0, D1.S1 (перенос сервера) и D1.E0 (карта расширений) завершены. [Карта всех файлов и проверок](docs/migration/EXTENSION_IMPORT_MAP.md) закрепляет Ozon 0.1.22 и WB 0.3.0. Следующий отдельный шаг — [D1.E1: перенос источников](docs/migration/EXTENSION_IMPORT_NEXT_STEP.md), затем D2: общее ядро. Сервер развивается параллельно отдельным Codex.
