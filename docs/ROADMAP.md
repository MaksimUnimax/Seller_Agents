...
Текущий этап: D0 COMPLETED. Следующий этап D1 ещё не начат; его выполнение этим документом не запускается.
...
| D1 | Отдельный перенос источников архитектором | Точные source-коммиты и файлы сопоставлены; сохранены проверки и ограничения; независимые исходные контуры воспроизводимы |
