...
D0 COMPLETED. По поручению владельца выполняется D1.S1 — перенос замороженного сервера; Ozon/WB ещё не переносятся.
...
| D1 (D1.S1 сервер IN_PROGRESS) | Отдельный перенос источников архитектором | Точные source-коммиты и файлы сопоставлены; сохранены проверки и ограничения; независимые исходные контуры воспроизводимы |
