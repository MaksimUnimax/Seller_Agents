...
В первую очередь: реальная почта/авторизация, согласованные контракты, тестовое размещение. S1.1 free beta eligibility и quota регистраций приняты; следующий будущий серверный участок — ранний I1.
