...
D0 COMPLETED. D1.S1 (перенос сервера) COMPLETED. Перенос Ozon/WB ещё не начат; общий D1 целиком не закрыт.
...
| D1 (D1.S1 сервер COMPLETED) | Отдельный перенос источников архитектором | Точные source-коммиты и файлы сопоставлены; сохранены проверки и ограничения; независимые исходные контуры воспроизводимы |
