...
S1.1 free beta eligibility и quota регистраций приняты. `I1-SRV.0`–`I1-SRV.4` исторически приняты на canonical `main` at `5d7c8853cc69dd95bc6e713cac3fb2aa0a63383` / PR6 ([I1-SRV.3 evidence](server/I1_SRV_3_BOOTSTRAP_TRUST_HANDOFF_ACCEPTANCE_2026-09-15.md), [I1-SRV.4 evidence](server/I1_SRV_4_ERROR_REVOCATION_OFFLINE_ACCEPTANCE_2026-09-15.md)). `I1-SRV.5` — `IMPLEMENTED_CANDIDATE / ARCHITECT_REVIEW_PENDING`; [reference acceptance](server/I1_SRV_5_REFERENCE_ACCEPTANCE_2026-09-16.md) and [synchronization handoff](server/I1_SERVER_EXTENSION_SYNC_2026-09-16.md) record the bounded candidate. No new roadmap order or follow-on implementation is opened.
