...
console.log(JSON.stringify({head:'d8f5157696d137750176d1aa44aedf9c2116404e',scope:'proposed Date.parse correction applied to exact callback; not full Zod/mapper/DB execution',results},null,2));
