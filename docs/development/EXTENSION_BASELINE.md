...
D2.1 начат: [общие модули и composed-сборка](EXTENSION_CORE.md). Baseline-команды этого документа по-прежнему проверяют неизменённые imported sources; новые модули проверяет отдельный core job.
