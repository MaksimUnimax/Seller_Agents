> В Seller Agents эти инженерные правила действуют вместе с корневым AGENTS.md и docs/decisions/DECISIONS.md. Старое откладывание интеграции до P11 заменено ранним I1. Нынешняя задача — D1.S1 перенос замороженного сервера; это не продолжение P8.4.
