...
Status: **M3 / R07 CLOSED / R11 START PASS / SUBMIT PENDING REMOTE READBACK GATE**.
...
R11_START = PASS
R11_START_REQUEST_EXECUTED = false
R11_START_PROVIDER_CALLS = 0
R11_PENDING = 1
R11_WAITING = 0
R11_SUCCEEDED = 0
R11_FAILED = 0
...
R11_SUBMIT = NOT YET EXECUTED
R11_SUBMIT_ONE = MAY BE RELEASED ONLY AFTER START RAW+ANALYSIS+THIS PROGRESS REMOTE READBACK
R11_COLLECT = BLOCKED
R11_EXPORT = BLOCKED
...
CURRENT_QUERY = R11
CURRENT_CURSOR = R11 START ACCEPTED / DURABLE READBACK REQUIRED
NEXT_PHYSICAL_ACTION = REMOTE READ BACK R11 START RAW + ANALYSIS + THIS PROGRESS; IF MATCH, RELEASE EXACTLY ONE submitN count=1 FOR octoport-serp-r11-20260917
