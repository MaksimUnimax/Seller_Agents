# M4A R2 — canonical ChatGPT Work execution prompt
...
2. Verify these release files exist:
   - docs/seo/serp/competitors/M4A_PRE_STEP_RESEARCH_AND_EXECUTION_GATE_2026-09-18_R2.md
   - docs/seo/serp/competitors/M4A_EXECUTION_RELEASE_2026-09-18_R2.md
   - docs/seo/serp/competitors/M4A_WORK_PROMPT_2026-09-18_R2.md
...
5. If governing M3/M4 authority or accepted M3 evidence materially drifted, or authority resolution is ambiguous/missing, STOP and return HOLD/AUTHORITY_DRIFT.
6. Otherwise execute.
...
Materialize one row for every accepted occurrence before dedupe with all mandatory fields/enums from the R2 gate.
...
Use the exact field requirements and enums in the R2 gate.
