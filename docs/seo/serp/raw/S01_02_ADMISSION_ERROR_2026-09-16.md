# SERP raw evidence — S01-02 repeated admission error
...
Ниже сохранён полный полученный `YMB_ERROR_V1`. Ошибка снова произошла до provider execution на стадии `MANUAL_ADMISSION`; никакой Search provider request выполнен не был.
...
YMB_ERROR_V1 {
  ...
  "timestamp": "2026-09-16T09:33:16.122Z",
  "operation_id": null
}
```
