...
- successful HTTP/provider calls: `8/15`;
- calls with usable `totalCount`: `8/15`;
- successful-empty result calls: `0`;
- provider failures: `0`;
- accumulated estimated cost: `0.16 ₽`;
- current cursor: `B02-09`;
- next seed: `ии агент для wildberries`.
