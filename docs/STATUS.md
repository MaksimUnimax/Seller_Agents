...
I1-SRV.0–I1-SRV.4 are historically accepted on canonical `main` at `5d7c8853cc69dd95bc6e713cac3fb2aa0a63383c` / PR6 with their original evidence preserved. I1-SRV.5 is `ACCEPTED` at `086ae20c2858849ec13b1ab67c2f7661259022c3` only for the bounded server/reference lifecycle and fixture gates. C1 is `ACCEPTED` at `56c81a3521c02502b65fd713aec890e5a30f038d` only for its bounded source/package/native and installed-local development scope. Their synchronization candidate is `IMPLEMENTED_CANDIDATE / ARCHITECT_REVIEW_PENDING` on `integration/i1-c1-srv5-2026-09-16`, merge `9d3407bc248e935860c5d7d3a50536c6a08d92f4`, with server first parent and client second parent. Canonical `main` remains the old SHA above; PR7 and PR8 remain draft/unmerged. Evidence: [I1-SRV.5 acceptance](server/I1_SRV_5_REFERENCE_ACCEPTANCE_2026-09-16.md), [synchronization handoff](server/I1_SERVER_EXTENSION_SYNC_2026-09-16.md), and [sync evidence](server/evidence/i1-sync-2026-09-16/README.md), plus the prior [I1-SRV.2 acceptance](server/I1_SRV_2_DEVICE_AUTH_INTEGRATION_ACCEPTANCE_2026-09-15.md), [I1-SRV.3 acceptance](server/I1_SRV_3_BOOTSTRAP_TRUST_HANDOFF_ACCEPTANCE_2026-09-15.md), and [I1-SRV.4 acceptance](server/I1_SRV_4_ERROR_REVOCATION_OFFLINE_ACCEPTANCE_2026-09-15.md). S1.2 remains NOT_STARTED.
...
I1-SRV.0–I1-SRV.4 are accepted on canonical `main` at `5d7c8853cc69dd95bc6e713cac3fb2aa0a63383c` / PR6 merge; older candidate wording remains historical evidence and does not reopen implementation. I1-SRV.5 adds only the bounded reference acceptance/handoff and is accepted only for that scope. Runtime key download, TOFU, extension consumption, and database migrations remain out of scope. D2.4 remains `DEVELOPMENT_APPLICATION_VERIFIED`, and `REAL_ACCOUNT_AUTH_NOT_CONNECTED` remains true. C1 is separately accepted at `56c81a3521c02502b65fd713aec890e5a30f038d`; C2/offline/profile integration, S1.2, D3, and Health boundaries remain pending.

The synchronization merge is a history-preserving implementation candidate only: it imports the two accepted heads whose changes were disjoint from the common ancestor. It does not reorder the roadmap or accept C2/offline/profile/joint command-result behavior. The previous disk-exhaustion `BLOCKED`, R1 integration `FAIL`, R2 setup-interlock `BLOCKED`, and deterministic RED/GREEN history remain historical evidence and are not rewritten as PASS. Health/P8.4 B5 remains NOT ACCEPTED; B6–B8 are queued. S1.2 real email/preprod, D3, full D2/I1, beta and release remain open.

Current bounded sync/C2.1 acceptance remains as recorded above: sync is an implementation candidate on `integration/i1-c1-srv5-2026-09-16`, and C2.1 is accepted only for durable context/time/restore and fresh-only Work guards at candidate `4acc5fb3336e3e38fa30d6a7ec16c80730bcd7e1`. C2.2-A is an implementation candidate pending architect review for verified cached-bootstrap configuration acquisition. It does not authorize offline Work, profile/capability execution, joint command/result completion, Health, domain migration, merge, deployment or release.
