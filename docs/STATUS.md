...
Этап: D1 COMPLETED — D1.S1/D1.E0/D1.E1 приняты. D1.E1 IMPORT_ACCEPTED: 232 файла, remote CI и readback PASS. D0 COMPLETED; D2 IN_PROGRESS, D2.1 ACCEPTED; D2.2 ACCEPTED — SOURCE/PACKAGE/REMOTE CI/READBACK PASS.
Product implementation: SERVER_IMPORTED_AND_VERIFIED; EXTENSION_BASELINES_IMPORTED_AND_VERIFIED; COMMON_CORE_COMPOSED_OZON_VERIFIED; BATCH_CONTEXT_VERIFIED; COMBINED_OZON_WB_RUNTIME_NOT_IMPLEMENTED.
...
| Единое расширение | Целевая архитектура согласована | D2.2: общая очередь и context guard в Ozon development 0.2.1; source/ZIP и remote CI/readback PASS; WB ещё не подключён |
